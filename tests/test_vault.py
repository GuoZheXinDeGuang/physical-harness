...
def test_fold_over_real_runs():
    ...
    # the three mounted skills + the 18 cards + the 9 capabilities are all present
    ...
    # recycle_cans, pack_lunch, steam_prep; 18th: the inactive policy_vla_remote
    # websocket transport card).
