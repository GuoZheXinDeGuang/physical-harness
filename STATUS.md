...
Round 46：**报告大改三处。**
(1) 新增「门禁的一个洞和它的补法」—— 这是全篇最有说服力的一段之一：**方法抓住了自己**，
    而且第一版补法太弱、被我自己在同一轮里抓了第二次；
(2) 两策略各四区块，合并数字更新（脚本 **+26.9pp / 800 episode 零破坏**，克隆 +18.5pp）；
(3) 第三种策略写进边界一节作为**下界证据**（策略弱到无条件干预就有巨大收益时，
    判断没有可赚的空间），**不是当成第三个成功案例**。
