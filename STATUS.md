...
Round 49：**给新门禁下的 bundle 补区块。** 现在每个策略在新门禁下只有一个区块，
违反自己立的纪律（头条至少三区块，round 34）。bundle 已冻结，只需评分 + 消融：
脚本 `finger_gap < 0.001823 @t=41`（sd=0.02）用 **11400-11599 / 11600-11799**；
克隆 `finger_gap > 0.069476 @t=59`（sd=0.010）用 **11800-11999 / 12000-12199**。
补完后成绩栏才能换成新门禁的数字。
