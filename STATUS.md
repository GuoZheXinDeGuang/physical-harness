...
Round 29：**用标定后的目标函数重跑克隆策略的 campaign**。
克隆策略上的 +12.0pp 是 earliness=0.25 时代赚的，和脚本策略一样需要重新赚。
如果它也涨，那说明标定的收益不限于一种失败形态。

**区块预算：** held-out 已用 1000-1999 五段 + 6000-6199；
选择区块用 2400-2549 / 2600-2749 / 2750-2899。克隆策略的 held-out 用 7000-7199。
